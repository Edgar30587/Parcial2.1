...
COPY ./lib/mysql-connector-j-8.2.0.jar /usr/local/tomcat/webapps/Parcial2.1/WEB-INF/lib/
COPY ./lib/javax.servlet.jsp.jstl-1.2.5.jar /usr/local/tomcat/webapps/Parcial2.1/WEB-INF/lib/
