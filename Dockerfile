...
COPY /mnt/data/mysql-connector-j-8.2.0.jar /usr/local/tomcat/webapps/Parcial2.1/WEB-INF/lib/
COPY /mnt/data/javax.servlet.jsp.jstl-1.2.5.jar /usr/local/tomcat/webapps/Parcial2.1/WEB-INF/lib/
